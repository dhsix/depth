...
class Depth2Elevation_Gradient(BaseDepthModel):
...
def create_depth2elevation_gra_model(config: Dict[str, Any]) -> Depth2Elevation_Gradient:
    """创建Depth2Elevation模型的工厂函数"""
    return Depth2Elevation_Gradient(config)